...
import Handsontable from 'handsontable/handsontable/tmp/base';
import { getRenderer } from 'handsontable/handsontable/tmp/renderers/registry';
import { getEditor } from 'handsontable/handsontable/tmp/editors/registry';
